...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface MallItemInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "burn" | "getApproved" | "isApprovedForAll" | "mintItem" | "name" | "owner" | "ownerOf" | "pause" | "paused" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenByIndex" | "tokenOfOwnerByIndex" | "tokenURI" | "totalMinted" | "totalSupply" | "transferFrom" | "transferOwnership" | "unpause"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "ItemMinted" | "MetadataUpdate" | "OwnershipTransferred" | "Paused" | "Transfer" | "Unpaused"): EventFragment;
...
encodeFunctionData(functionFragment: 'mintItem', values: [AddressLike, string]): string;
...
decodeFunctionResult(functionFragment: 'unpause', data: BytesLike): Result;
    ...
    export namespace ItemMintedEvent {
      export type InputTuple = [owner: AddressLike, tokenId: BigNumberish, tokenURI: string];
      export type OutputTuple = [owner: string, tokenId: bigint, tokenURI: string];
      export interface OutputObject {owner: string, tokenId: bigint, tokenURI: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface MallItem extends BaseContract {
    
    connect(runner?: ContractRunner | null): MallItem;
    waitForDeployment(): Promise<this>;

    interface: MallItemInterface;
